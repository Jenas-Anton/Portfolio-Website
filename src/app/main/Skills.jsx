          ...
          {SkillData.map((skill, index) => (
            <SwiperSlide key={index} className="flex flex-col items-center">
              <Image
                ...
                height={skill.height}
              />
              <p className="mt-2 text-white text-sm">{skill.name}</p> {/* Label here */}
            </SwiperSlide>
          ))}
        </Swiper>
          ...
          {SkillData.map((skill, index) => (
            <SwiperSlide key={index} className="flex flex-col items-center">
              <Image
                ...
                height={skill.height}
              />
              <p className="mt-2 text-white text-sm text-center">{skill.name}</p> {/* Label here */}
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
